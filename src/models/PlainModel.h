...
public:
	PlainModel() : Model() {
		...
		GLuint image = SOIL_load_OGL_texture("/Users/stefanmelicher/Documents/School/zpgproj/src/textures/grass.png", SOIL_LOAD_RGBA, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
		if (image == NULL) {
